// Generated from the OSRS Wiki real-time item mapping.
// Exact names learned from the live Solanascape client take precedence.
export const STANDARD_ITEM_NAMES: Readonly<Record<number, string>> = Object.freeze({
  "2": "Steel cannonball",
  "6": "Cannon base",
  "8": "Cannon stand",
  "10": "Cannon barrels",
